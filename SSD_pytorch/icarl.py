...
class iCaRL(nn.Module):
    ...
    def update_representation(self, experiment, dataset, batch_size, epochs, inc_phase, learning_rate):
        ...
        for indices, images, labels in loader:
            ...
            output = torch.sigmoid(self.forward(images))
            previous_logits[indices] = output.data
        ...
        for epoch in np.arange(epochs):
            ...
            for i, (indices, images, labels) in enumerate(loader):
                ...
                if self.n_known > 0:
                    ...
                    # loss = self.crossentropy(valid_output, torch.argmax(valid_targets, dim=1))
                    ...
                    dist_loss = self.smoothL1(torch.sigmoid(dist_output), dist_targets)
                    loss += dist_loss
                else:
